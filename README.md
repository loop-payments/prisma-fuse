...
Options:
  ...
  --add-namespace-from-file-name     Adds a `/// @namespace {namespace}` comment before each model using the prisma file name. Compatible with https://github.com/samchon/prisma-markdown. (default: false)
